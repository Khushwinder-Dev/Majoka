...
const PROJECTS: Project[] = [
  ...
  {
    id: 16,
    title: "Samana Mykonos at Dubai Studio City",
    titleAr: "منشأة التجميع الدقيق",
    location: "Sharjah, United Arab Emirates",
    locationAr: "الشارقة، الإمارات العربية المتحدة",
    category: "manufacturing",
    image: "/projects/imgs/16.jpg",
    refCode: "016",
    date: "2024-09-12",
  },
  ...
  {
    id: 18,
    title: "SAMANA Mykonos by Samana in Dubai Studio City",
    titleAr: "محطة معالجة المياه",
    location: "Abu Dhabi, United Arab Emirates",
    locationAr: "أبوظبي، الإمارات العربية المتحدة",
    category: "infrastructure",
    image: "/projects/imgs/18.jpg",
    refCode: "018",
    date: "2024-07-21",
  },
