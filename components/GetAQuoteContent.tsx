...
export default function GetAQuoteContent() {
  ...
  // FAQ Accordion State (all closed or toggleable)
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          ...
          {
            duration: 6000,
            style: { background: "#00b3a4", color: "#fff", padding: "16px", borderRadius: "10px" },
          }
        );
        setFormData({
          fullName: "",
  ...
  return (
    <div className="w-full bg-white overflow-hidden" dir={isArabic ? "rtl" : "ltr"}>
      ...
      <section className="relative w-full h-[320px] sm:h-[380px] md:h-[430px] lg:h-[460px] xl:h-[490px] flex items-center bg-[#071d34] overflow-hidden">
        {/* Background Image */}
        <Image
          src="/get-a-quote/quote-hero-banner.png"
        ...
        {/* Left deep dark/teal gradient overlay as per design reference */}
      ...
      {/* ══════════════════════════════════════════════════════════════
          2. MAIN SECTION: 2-COLUMN INTRO & QUOTE FORM
      ══════════════════════════════════════════════════════════════ */}
      <section className="relative w-full py-16 sm:py-20 lg:py-24 bg-[#f8fafb]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">

            {/* ── LEFT COLUMN: Text + 3 Badges + Architecture Photo ── */}
            <div className="lg:col-span-5 flex flex-col">
              
              {/* Tagline */}
              <div className="flex items-center gap-2 mb-3">
                <span className="w-5 h-[2px] bg-[#00b3a4]" />
                <span className="text-[11px] sm:text-[12px] font-extrabold tracking-[0.2em] text-[#00b3a4] uppercase">
                  {isArabic ? "طلب عرض سعر" : "GET A QUOTE"}
                </span>
              </div>

              {/* Main Heading */}
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-extrabold text-[#0d2438] leading-[1.2] tracking-tight mb-4">
                {isArabic ? (
                  <>
                    مشروعك يبدأ <br />
                    <span className="text-[#00b3a4]">بمحادثة معنا</span>
                  </>
                ) : (
                  <>
                    Your Project <br />
                    Starts with <br />
                    <span className="text-[#00b3a4]">a Conversation</span>
                  </>
                )}
              </h2>

              {/* Subtitle */}
              <p className="text-stone-500 text-xs sm:text-sm leading-relaxed mb-8 max-w-md">
                {isArabic
              ...
              <div className="flex flex-wrap items-center gap-5 sm:gap-6 mb-10">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full border border-[#00b3a4]/40 bg-[#e0f7f4] flex items-center justify-center text-[#00b3a4] flex-shrink-0 shadow-xs">
              ...
              <div className="relative w-full h-[360px] sm:h-[420px] rounded-3xl overflow-hidden shadow-lg border border-stone-100">
                <Image
                  src="/get-a-quote/quote-side-arch.png"
                  alt="Taj Al Rahmah Modern Architecture"
                  fill
                  unoptimized
            ...
            {/* ── RIGHT COLUMN: Tell Us About Your Project Form Card ── */}
            <div className="lg:col-span-7">
              <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-[0_12px_45px_rgba(0,158,144,0.07)] border border-stone-200/80">
                
                {/* Card Tagline */}
                <div className="flex items-center gap-2 mb-2">
                  <span className="w-4 h-[2px] bg-[#00b3a4]" />
                  <span className="text-[11px] sm:text-[12px] font-extrabold tracking-[0.2em] text-[#00b3a4] uppercase">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#fbfcfc] border border-stone-200 rounded-xl px-4 py-3 text-xs sm:text-sm text-stone-800 placeholder-stone-400 focus:outline-none focus:border-[#00b3a4] focus:ring-2 focus:ring-[#00b3a4]/15 transition-all"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full bg-[#fbfcfc] border border-stone-200 rounded-xl px-4 py-3 text-xs sm:text-sm text-stone-700 focus:outline-none focus:border-[#00b3a4] focus:ring-2 focus:ring-[#00b3a4]/15 transition-all cursor-pointer"
                      >
                        <option value="">{isArabic ? "اختر نوع المشروع" : "Select project type"}</option>
                        <option value="Waterproofing & Structural Insulation">
                          {isArabic ? "العزل المائي والإنشائي المتكامل" : "Waterproofing & Structural Insulation"}
                        </option>
                        <option value="Combo Roofing Insulation System">
                          {isArabic ? "نظام الكومبو المتكامل للأسطح" : "Combo Roofing Insulation System"}
                        </option>
                        <option value="GRP & Fiberglass Tank Lining">
                          {isArabic ? "تبطين خزانات المياه بـ GRP والألياف الزجاجية" : "GRP & Fiberglass Tank Lining"}
                        </option>
                        <option value="Epoxy Floor Coating">
                          {isArabic ? "طلاء أرضيات الإيبوكسي الصناعية" : "Epoxy Floor Coating"}
                        </option>
                        <option value="Bitumen Membrane Waterproofing">
                          {isArabic ? "عزل الأغشية البيتومينية المسلحة" : "Bitumen Membrane Waterproofing"}
                        </option>
                        <option value="Polyurea Spray Coating">
                          {isArabic ? "طلاء رذاذ البولي يوريا السريع" : "Polyurea Spray Coating"}
                        </option>
                        <option value="Crack Injection & Leak Sealing">
                          {isArabic ? "حقن الشقوق ومعالجة التسربات" : "Crack Injection & Leak Sealing"}
                        </option>
                        <option value="Other Specialist Technical Works">
                          {isArabic ? "أعمال فنية وهندسية أخرى" : "Other Specialist Technical Works"}
                        </option>
                      </select>
                    </div>
                  ...
                  <div>
                    <label className="block text-xs sm:text-[13px] font-bold text-stone-700 mb-1.5">
                      {isArabic ? "تفاصيل المشروع" : "Project Details"} <span className="text-red-500">*</span>
                    </label>
                    <textarea
                      name="projectDetails"
                      required
                      ...
                      onChange={handleInputChange}
                      placeholder={isArabic ? "صف نطاق العمل، المساحة التقريبية، المتطلبات الخاصة..." : "Describe the scope of work, approximate area, special requirements..."}
                      className="w-full bg-[#fbfcfc] border border-stone-200 rounded-xl px-4 py-3 text-xs sm:text-sm text-stone-800 placeholder-stone-400 focus:outline-none focus:border-[#00b3a4] focus:ring-2 focus:ring-[#00b3a4]/15 transition-all resize-y"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-xs sm:text-[13px] font-bold text-stone-700 mb-1.5">
                      {isArabic ? "إرفاق ملفات أو مخططات (اختياري)" : "Upload Files (Optional)"}
                    </label>
                    <div
                      onClick={() => fileInputRef.current?.click()}
                      className="w-full border-2 border-dashed border-stone-200 hover:border-[#00b3a4] bg-[#fbfcfc] hover:bg-[#e0f7f4]/20 rounded-2xl p-5 text-center cursor-pointer transition-all"
                    >
                      <Upload className="w-6 h-6 text-stone-400 mx-auto mb-2 group-hover:text-[#00b3a4]" />
                      <p className="text-xs sm:text-sm font-semibold text-stone-700">
                        {isArabic ? "اسحب الملفات وأفلتها هنا أو " : "Drag & drop files here or "}
                        <span className="text-[#00b3a4] underline">{isArabic ? "تصفح" : "browse"}</span>
                      </p>
                      <p className="text-[11px] text-stone-400 mt-1">
                        {isArabic ? "الملفات المدعومة: PDF, JPG, PNG (بحد أقصى 10 ميجابايت)" : "Support: PDF, JPG, PNG (Max 10MB)"}
                      </p>
                      <input
                        ref={fileInputRef}
                        type="file"
                    ...
                    {files.length > 0 && (
                      <div className="mt-2 text-xs text-[#00b3a4] font-medium">
                  ...
                  <div className="flex items-start gap-2.5 pt-1">
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-4 h-4 mt-0.5 accent-[#00b3a4] rounded cursor-pointer"
                    />
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full bg-[#00b3a4] hover:bg-[#009e90] active:scale-[0.99] text-white font-bold text-sm sm:text-base py-3.5 sm:py-4 rounded-full shadow-lg shadow-[#00b3a4]/25 transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
                        ...
                        <>
                          <span>{isArabic ? "إرسال طلب عرض السعر" : "Request a Quote"}</span>
                          {isArabic ? (
      ...
      ══════════════════════════════════════════════════════════════ */}
      <section className="relative w-full py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-[#edf8f6] via-[#e5f5f3] to-[#f4faf9] overflow-hidden">
        
        {/* Decorative Side Curves */}
        <div className="absolute left-0 top-10 pointer-events-none select-none opacity-80 z-0">
          <Image
        ...
        <div className="absolute right-0 top-10 pointer-events-none select-none opacity-80 z-0">
          <Image
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10 sm:mb-12">
            <div className="flex items-center justify-center gap-2 mb-2.5">
              <span className="w-5 h-[1.5px] bg-[#00b3a4]" />
              <span className="text-[11px] sm:text-[12px] font-extrabold tracking-[0.2em] text-[#00b3a4] uppercase">
              ...
              return (
                <div
                  ...
                  className={`bg-white border transition-all duration-300 overflow-hidden ${
                    isOpen
                      ? "rounded-2xl sm:rounded-3xl border-[#00b3a4]/40 shadow-[0_8px_24px_rgba(0,179,164,0.08)]"
                      : "rounded-full border-stone-200/90 hover:border-[#00b3a4]/40 shadow-xs hover:shadow-sm"
                  }`}
                >
                  <button
                    type="button"
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#e0f7f4] text-[#00b3a4] text-xs sm:text-[13px] font-bold flex items-center justify-center flex-shrink-0 transition-colors group-hover:bg-[#00b3a4] group-hover:text-white">
                        {formattedNum}
                      </div>

                      <span
                        className={`text-[13px] sm:text-[15px] font-semibold leading-snug transition-colors ${
                          isOpen ? "text-[#00b3a4]" : "text-stone-800 group-hover:text-[#00b3a4]"
                        }`}
                      >
                    ...
                    <div
                      className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-colors ${
                        isOpen
                          ? "bg-[#e0f7f4] text-[#00b3a4]"
                          : "bg-[#e0f7f4] text-[#00b3a4] group-hover:bg-[#00b3a4] group-hover:text-white"
                      }`}
                    >
                      {isOpen ? (
                  ...
                  {isOpen && (
                    <div className="px-4 sm:px-6 pb-4 sm:pb-5 pt-0 text-xs sm:text-[14px] text-[#00b3a4] font-medium leading-relaxed">
      ...
      <section className="relative w-full py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative w-full rounded-3xl lg:rounded-[32px] overflow-hidden shadow-xl border border-stone-100 bg-[#082b35]">
            
            {/* Background Graphic */}
            <div className="relative w-full min-h-[360px] sm:min-h-[400px] lg:min-h-[420px]">
              <Image
                src="/get-a-quote/talk-to-experts-bg.png"
              ...
              <div className="md:absolute inset-0 flex flex-col justify-center px-6 sm:px-10 lg:px-14 py-8 md:py-0">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                  ...
                  {/* Middle Column: Interactive Contact Channels */}
                  <div className="md:col-span-4 space-y-4 text-white">
                    ...
                    >
                      <div className="w-11 h-11 rounded-full border border-white/20 bg-white/10 flex items-center justify-center text-[#3CD3C1] flex-shrink-0 group-hover:scale-105 transition-transform">
                        <Phone className="w-5 h-5" />
                      </div>
                      <div>
                        <div className="text-sm sm:text-base font-bold text-white tracking-wide group-hover:text-[#3CD3C1] transition-colors">
                          +971 55 617 3300
                        </div>
                    ...
                    <div className="flex items-center gap-3.5 p-2">
                      <div className="w-11 h-11 rounded-full border border-white/20 bg-white/10 flex items-center justify-center text-[#3CD3C1] flex-shrink-0">
                  ...
                  {/* Right Column: Architectural Visual space on desktop */}
