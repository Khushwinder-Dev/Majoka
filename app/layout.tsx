...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <link rel="icon" href="/TajAlrahmanlqogo.png" sizes="any" />
        <link rel="icon" href="/TajAlrahmanlqogo.png" type="image/png" />
        <link rel="apple-touch-icon" href="/TajAlrahmanlqogo.png" />
      </head>
      <body
